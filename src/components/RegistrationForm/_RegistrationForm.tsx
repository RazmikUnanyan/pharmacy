    ...
    <Modal isOpen={isOpen} onClose={onClose}>
        <form className={styles.registrationForm}  onSubmit={handleSubmit}>
            ...
            <main className={styles.inputWrapper}>
                <Input id="name" name="name" label="Имя" onChange={handleChange}  value={formData.name}placeholder="Введите имя"/>
                <Input id="phone" name="phone" maxLength="12" onChange={handleChange} value={formData.phone} label="Мобильный телефон" placeholder="+7" type="number"/>
            </main>
